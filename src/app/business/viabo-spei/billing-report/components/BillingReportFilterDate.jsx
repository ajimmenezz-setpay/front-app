...
export function BillingReportFilterDate({ setFilterDate, filterDate, isLoading }) {
  ...
  const isCurrentMonth = () => {
    ...
    return filterDate.getMonth() === currentDate.getMonth() && filterDate.getFullYear() === currentDate.getFullYear()
  }
  ...
  const handleMonthChange = event => {
    const newMonth = new Date(filterDate)
