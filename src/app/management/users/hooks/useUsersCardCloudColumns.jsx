...
import { UserCardsColumn } from '../components/users-by-card-cloud/UserCardsColumn'

export const useUsersCardCloudColumns = () => {
  ...
  return useMemo(
    () => [
      ...
      columnHelper.accessor('cards', {
        id: 'cards',
        header: 'Tarjetas',
        accessorFn: originalRow => originalRow?.cards?.names ?? null,
        Cell: ({ cell, column, row, renderedCellValue }) => {
          const { original: rowData } = row
          return <UserCardsColumn row={rowData} />
        }
      }),
