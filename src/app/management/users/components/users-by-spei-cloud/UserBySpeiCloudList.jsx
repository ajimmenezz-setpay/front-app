...
import { useFindSpeiCloudUsers, useUsersSpeiCloudColumns } from '../../hooks'
...
export const UserBySpeiCloudList = () => {
  const { isError, error, data: users, isLoading, isFetching, refetch } = useFindSpeiCloudUsers()

  const columns = useUsersSpeiCloudColumns()
  ...
  const table = useMaterialTable(isError, error, {
    ...
    renderToolbarInternalActions: ({ table }) => (
      <MaterialDataTableToolbarExportActions
        table={table}
        columns={columns}
        fileName={'Lista de Usuarios Administradores de Empresas'}
